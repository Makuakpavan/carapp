...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Discover the groundbreaking electric vehicles set to redefine luxury mobility in the coming year.",
  ...
  },
  {
    id: 2,
    title:
      "Maintaining Your Investment: Essential Care Tips for Luxury Vehicles",
    category: "Maintenance",
    date: "December 10, 2024",
    excerpt:
      "Expert advice on keeping your premium vehicle in pristine condition for years to come.",
  ...
  },
  {
    ...
    excerpt:
      "Our comprehensive review of Mercedes-AMG's latest sports car masterpiece.",
  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        {/* Header */}
        <div
          className={`flex flex-col md:flex-row md:items-end md:justify-between mb-16 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div>
          ...
          <p className="section-description max-w-md mt-4 md:mt-0">
            Stay informed with the latest trends, reviews, and stories from the
