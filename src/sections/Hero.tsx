...
const slides: Slide[] = [
  {
    ...
    description: 'Discover our exclusive collection of premium vehicles. Each car tells a story of craftsmanship, performance, and unparalleled elegance.',
  ...
  },
  {
    ...
    description: 'From sleek sports cars to elegant sedans, find the perfect vehicle that matches your style and ambition.',
    cta: 'View Inventory',
  },
  {
    id: 3,
    ...
    description: 'Premium service, exceptional quality, and a commitment to exceeding your expectations.',
    cta: 'Contact Us',
  },
];
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden">
              ...
              >
                {index === currentSlide && (
                  <>
                    ...
                    <h1 
                      className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-normal mb-6 leading-tight"
                    ...
                    <p 
                      className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl leading-relaxed animate-fade-in"
      ...
      {/* Navigation Arrows */}
      <div className="absolute bottom-1/2 translate-y-1/2 left-4 right-4 z-30 flex justify-between pointer-events-none">
        <button
          onClick={prevSlide}
