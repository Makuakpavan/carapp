...
const features = [
  {
    ...
    description: 'From European elegance to American power, explore our diverse collection.',
  },
  {
    icon: Wrench,
  ...
  },
  {
    ...
    description: 'Our commitment to excellence has earned us thousands of loyal clients.',
  },
  {
    icon: DollarSign,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <p className="section-description mb-10">
              With over two decades of experience in the luxury automotive industry, 
              we pride ourselves on delivering exceptional vehicles and unparalleled 
              customer service. Our curated collection represents the finest automobiles 
          ...
          >
            <div className="relative">
              ...
              <div className="absolute bottom-8 left-8 bg-black/90 backdrop-blur-sm p-6 border border-[#FFD700]/30">
                <div className="text-5xl font-bold text-[#FFD700] mb-1" style={{ fontFamily: 'Playfair Display, serif' }}>
                  20+
                </div>
